...
must_haves:
  truths:
    ...
    - "Report completion email is sent via Resend with link to report"
...
<task type="auto">
  ...
  <action>
    ...
    **Step 2: Pre-calculate budget**
    ...
    - Calculate estimated total cost using the same formula as cost-estimator.ts
    - Log the projected cost
...
<task type="auto">
  ...
  <action>
    ...
    **3. Wire email into engine.ts:**
    ...
    - Call sendReportReadyEmail with user email, report details
